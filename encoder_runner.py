...
def run_encoder(encoder_type="auto", n_epochs=10, batch_size=100):
    ...
    train_images_blur, test_images_blur = image_grabber.grab_images('dataset_blurred/architecure')
    train_images, test_images = image_grabber.grab_images('dataset/architecure')
